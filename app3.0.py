...
專家增強最終版實作 (V5.8 - Dark Theme Revert & News Section)
...
版本：5.8.0 (Dark Theme Revert & News Section)
"""
    ...
    with st.spinner(f'AI 分析引擎啟動中...'):
        ...
        if data is not None and len(data) > 50:
            ...
            if df.empty:
                ...
                # (NEW v5.8) 最新相關新聞
                st.markdown("<h3>📰 最新相關新聞</h3>", unsafe_allow_html=True)
                if funda['news']:
                    for news_item in funda['news']:
