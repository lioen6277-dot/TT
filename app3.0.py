...
專家增強最終版實作 (V5.3 - Chart Scaling Fix)
...
- [修復] 修正因成交量縮放導致主圖 K 線被壓縮的 Bug
- 擴充資產庫與智慧搜尋
- 精煉版技術指標計算引擎 (TA-Lib)
- AI 融合信號生成模型

開發者：程式碼專家 (Generated by Gemini)
版本：5.3.0 (Chart Scaling Fix)
"""
    ...
    with st.spinner(f'AI 分析引擎啟動中...'):
        ...
        if data is not None and len(data) > 50:
            ...
            if df.empty:
                ...
                # 圖 1: K線與移動平均線 + 成交量 (使用第二Y軸)
                fig.add_trace(go.Candlestick(x=df.index, open=df['Open'], high=df['High'], low=df['Low'], close=df['Close'], name='K線',
                                             increasing_line_color='#28a745', decreasing_line_color='#dc3545'), row=1, col=1, secondary_y=False)
