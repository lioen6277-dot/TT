...
專家增強最終版實作 (V12.1 - Crypto Asset Expansion)
...
FULL_SYMBOLS_MAP = {
    ...
    "ETH-USD": {"name": "以太坊", "keywords": ["以太坊", "ETH", "ethereum"]},
    "BNB-USD": {"name": "幣安幣", "keywords": ["幣安幣", "BNB", "Binance Coin"]},
    "SOL-USD": {"name": "Solana", "keywords": ["Solana", "SOL"]},
    "DOGE-USD": {"name": "狗狗幣", "keywords": ["狗狗幣", "DOGE", "Dogecoin"]},
    "ADA-USD": {"name": "艾達幣", "keywords": ["艾達幣", "ADA", "Cardano"]},
    "XRP-USD": {"name": "瑞波幣", "keywords": ["瑞波幣", "XRP", "Ripple"]},
    "LINK-USD": {"name": "Chainlink", "keywords": ["Chainlink", "LINK"]},
    "ASTR-USD": {"name": "Astar", "keywords": ["Astar", "ASTER", "ASTR"]},
    "WIF-USD": {"name": "dogwifhat", "keywords": ["dogwifhat", "WIF"]},
    "SHIB-USD": {"name": "柴犬幣", "keywords": ["柴犬幣", "SHIB", "Shiba Inu"]},
    "POPCAT-USD": {"name": "Popcat", "keywords": ["Popcat", "POPCAT", "POPCA"]},
}
