...
專家增強最終版實作 (V5.6 - Numeric Color Coding)
...
核心功能：
- [升級] 將色彩邏輯延伸至儀表板數值 (評分, TP/SL)，實現完全的視覺統一
- [微調] 移除側邊欄圖示，介面更簡潔
...
# (UPDATED v5.4) 全局 CSS 樣式，實現像素級復刻並統一色彩邏輯
st.markdown("""
<style>
    /* 全局暗色主題 */
    body, .stApp {
    ...
    with st.spinner(f'AI 分析引擎啟動中...'):
        ...
        if data is not None and len(data) > 50:
            ...
            if df.empty:
                ...
                fig.update_yaxes(showticklabels=False, showgrid=False, zeroline=False, row=1, col=1, secondary_y=True) # 隱藏成交量Y軸
