...
專家增強最終版實作 (V8.2 - Supertrend Bugfix)
...
def calculate_indicators(df):
    ...
    supertrend = [True] * len(df) # Default to uptrend
    ...
    supertrend_line = [lower_band[i] if supertrend[i] else upper_band[i] for i in range(len(df))]
