...
def calculate_risk_management(df):
    """
    多策略共識止盈止損計算。
    (FIXED v1.1.0) 增加了防禦性程式碼，在存取指標前先檢查其是否存在。
    Args:
                ...
                with col_main:
                    ...
                    indicators_df = pd.DataFrame({
                        ...
                        '數值': [
                            ...
                            f"{latest_indicators.get('BBL_20_2.0', 'N/A'):.1f} - {latest_indicators.get('BBU_20_2.0', 'N/A'):.1f}"
                        ],
                        'AI 判讀': [
                            ...
                            "波動放大" if (latest_indicators.get('BBU_20_2.0', 0) - latest_indicators.get('BBL_20_2.0', 0)) / latest_indicators.get('Close', 1) > 0.05 else "波動收斂"
                        ]
                    })
